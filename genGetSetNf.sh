...
cat $1 | grep private | awk 'BEGIN { FS = "  | |;" }
{
  ...
  if (varName != "") {
    ...
    print "   **/" ;
    print "  public " varType " get" toupper(substr(varName,1,1)) substr(varName, 2) "() {";
    ...
    print "   **/" ;
    print "  public void set" toupper(substr(varName,1,1)) substr(varName, 2) "(final " varType " p" toupper(substr(varName,1,1)) substr(varName, 2) ") {";
